...
BuildRequires: %{?scl_prefix}mvn(args4j:args4j)
BuildRequires: %{?scl_prefix_maven}mvn(com.google.inject:guice)
BuildRequires: %{?scl_prefix_maven}mvn(com.sun.codemodel:codemodel)
BuildRequires: %{?scl_prefix_java_common}mvn(javax.el:javax.el-api)
BuildRequires: %{?scl_prefix_maven}mvn(javax.enterprise:cdi-api)
...
BuildRequires: %{?scl_prefix_java_common}mvn(org.apache.ant:ant-launcher)
...
BuildRequires: %{?scl_prefix_maven}mvn(org.apache.maven:maven-archiver)
BuildRequires: %{?scl_prefix_maven}mvn(org.apache.maven:maven-artifact)
...
BuildRequires: %{?scl_prefix_java_common}mvn(org.easymock:easymock:3.3)
...
Obsoletes:     %{?scl_prefix}osgi-resource-locator < %{version}-%{release}
Provides:      %{?scl_prefix}osgi-resource-locator = %{version}-%{release}
...
%pom_disable_module persistence hk2-configuration
...
%pom_change_dep org.easymock:easymock org.easymock:easymock:3.3
...
%mvn_package ":consolidatedbundle-maven-plugin" __noinstall
...
%changelog
* Sat Jul 23 2016 Mat Booth <mat.booth@redhat.com> - 2.4.0-2.2
- Build using the easymock3 compat package
- Disable unbuildable modules spring-bridge, persistence
- Don't package maven plugins

* Sat Jul 23 2016 Mat Booth <mat.booth@redhat.com> - 2.4.0-2.1
